...
| 8 | 2026-08-16 | configure-pages enablement:true failed ("Resource not accessible by integration"): GitHub admin-gates Pages *creation* post-CVE — no session-reachable token can do it. | closed — rung ladder corrected in repo-admin; irreducible one-click enablement documented; rung-3 push-driven ADMIN_TOKEN reconciler specified for when the second admin need appears |
